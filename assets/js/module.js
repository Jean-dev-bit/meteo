...
/**
 *
 * @param {number} timeUnix TimeUnix shift from UTC in seconds
 * @param {number} timezone  Timezone shift from UTC in seconds
 * @returns {string} Time String formate: "03:50 AM/PM"
 */
...
export const aqiText = {
  ...
  3: {
    level: "Moderate",
    message:
      "Members of sensitive groups may experiences health effects. The general public is not likely to be affected.",
  },
